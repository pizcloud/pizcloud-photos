...
class NewLibraryPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final gallery = PizGallery(
      ...
      viewerQuickActionsTexts: ViewerQuickActionsTexts(
        quickActionsButtonLabel: 'library_quick_actions_title'.tr(),
        quickActionsSheetTitle: 'library_quick_actions_title'.tr(),
        quickActionsSheetMessage: 'library_quick_actions_subtitle'.tr(),
        shareLabel: 'share'.tr(),
        uploadLabel: 'upload'.tr(),
        editLabel: 'edit'.tr(),
        addToAlbumLabel: 'add_to_album'.tr(),
