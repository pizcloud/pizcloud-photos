...
class DescriptionInput extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (hasError.value) {
      suffixIcon = Icon(
        context.platformIcon(material: Icons.warning_outlined, cupertino: CupertinoIcons.exclamationmark_triangle),
      );
      ...
      suffixIcon = IconButton(
        ...
        icon: Icon(context.platformIcons.clear, color: context.colorScheme.onSurfaceSecondary),
        splashRadius: 10,
      );
    }
