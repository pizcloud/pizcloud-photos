...
class PowerStatus {
  PowerStatus({required this.isCharging, this.batteryLevelPercent, required this.isLowPowerMode});
  ...
  List<Object?> _toList() {
    return <Object?>[isCharging, batteryLevelPercent, isLowPowerMode];
  }
  ...
  static PowerStatus decode(Object result) {
    result as List<Object?>;
    return PowerStatus(
      isCharging: result[0]! as bool,
      batteryLevelPercent: result[1] as int?,
      isLowPowerMode: result[2]! as bool,
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! PowerStatus || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 130:
        return PowerStatus.decode(readValue(buffer)!);
      default:
...
class BackgroundWorkerFgHostApi {
  ...
  Future<PowerStatus> getPowerStatus() async {
    final String pigeonVar_channelName =
        'dev.flutter.pigeon.immich_mobile.BackgroundWorkerFgHostApi.getPowerStatus$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as PowerStatus?)!;
    }
  }
