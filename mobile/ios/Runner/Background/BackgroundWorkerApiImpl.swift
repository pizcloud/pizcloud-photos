...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  func disable() throws {
    ...
    BGTaskScheduler.shared.cancel(
      taskRequestWithIdentifier: BackgroundWorkerApiImpl.processingTaskID)
    print("BackgroundWorkerApiImpl:disableUploadWorker Disabled background workers")
  }

  private static let refreshTaskID = "com.pizcloud.photos.background.refreshUpload"
  private static let processingTaskID = "com.pizcloud.photos.background.processingUpload"
  ...
  private static func runBackgroundWorker(
    task: BGTask, taskType: BackgroundTaskType, maxSeconds: Int?
  ) {
